        ...
        <div>
            <div className="flex flex-col sm:flex-row w-full h-screen">
                ...
                <div className="flex flex-col items-center justify-center w-full sm:w-1/2 h-1/2 sm:h-full text-center bannerColor text-indigo-700 p-8">
                    <h1 className="text-3xl custom-heading font-extrabold sm:text-4xl md:text-5xl lg:text-5xl animate-slideInRight">
                        THESIS PROJECT HUB
                    </h1>
                    <h4 className="mt-4 text-bold sm:text-base md:text-lg lg:text-xl sub-heading animate-slideInRight">
            ...
            <div className="relative z-20 flex flex-col items-center justify-center mt-10 space-y-4 bg-transparent sm:flex-row sm:space-x-4 sm:space-y-0 sm:-mt-16">
                ...
                <div className="w-full max-w-sm p-6 bg-white rounded-lg shadow-lg text-center h-72 sm:h-80 border-t-8 border-indigo-500 animate-slideInRight">
                ...
                <div className="w-full max-w-sm p-6 bg-white rounded-lg shadow-lg text-center h-72 sm:h-80 border-t-8 border-indigo-500 animate-slideInBottom">
